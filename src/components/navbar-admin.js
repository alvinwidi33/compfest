    ...
    <nav className="bg-white shadow-sm py-4 w-full fixed top-0 z-50">
      <div className="container mx-auto flex items-center justify-between font-[Poppins, sans-serif]">
        <div className="flex items-center space-x-8 ml-6">
          ...
          <Link to="/list-salon" className="text-[#020030] hover:text-[#8A60FF] font-medium active:text-[#020030] mt-2">Daftar Cabang</Link>
          <Link to="/list-user" className="text-[#020030] hover:text-[#8A60FF] font-medium active:text-[#020030] mt-2">Daftar User</Link>
        </div>
